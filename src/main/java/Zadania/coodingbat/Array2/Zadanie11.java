...
public class Zadanie11 {
    public static void main(String[] args) {
        ...
        wyswietlacz(fizzArray2(4));
        wyswietlacz(fizzArray2(10));
        wyswietlacz(fizzArray2(2));

    }
    public static String[] fizzArray2(int n) {
        List<String> lista = new ArrayList<>();
        for(int i = 0; i<= n-1; i++){
           // lista.add(new StringBuilder().append('"').append(i).append('"').toString());
            lista.add(String.valueOf(i));
        }
        return lista.stream().toArray(String[]::new);
    }
